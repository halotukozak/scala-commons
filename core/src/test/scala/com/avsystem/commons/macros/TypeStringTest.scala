...
object TypeStringTest {
  ...
  inline def defineTests[T: TypeString](suite: TypeStringTest): Unit = {
    type LocalAlias = Int

    import suite.testTypeString
    testTypeString[Int]("Int")
    testTypeString[LocalAlias]("LocalAlias")
    testTypeString[StaticAlias]("StaticAlias")
...
class TypeStringTest extends AnyFunSuite {
  inline def testTypeString[T](expected: String)(using pos: Position): Unit =
