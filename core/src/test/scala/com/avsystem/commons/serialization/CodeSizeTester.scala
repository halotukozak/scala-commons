...
final case class CodeSizeTester00(
  int: Int,
  string: String,
  double: Double,
...
final case class CodeSizeTester01(
  int: Int,
  string: String,
  double: Double,
  map: Map[String, List[Boolean]],
...
final case class CodeSizeTester02(
  int: Int,
  string: String,
  double: Double,
  map: Map[String, List[Boolean]],
...
final case class CodeSizeTester04(
  int: Int,
  string: String,
  double: Double,
  map: Map[String, List[Boolean]],
...
final case class CodeSizeTester05(
  int: Int,
  string: String,
  double: Double,
  map: Map[String, List[Boolean]],
...
final case class CodeSizeTester06(
  int: Int,
  string: String,
  double: Double,
  map: Map[String, List[Boolean]],
...
final case class CodeSizeTester08(
  int: Int,
  string: String,
  double: Double,
  map: Map[String, List[Boolean]],
...
final case class Person(name: String, birthYear: Int, planet: String = "Earth")

object Person:
  given codec: GenCodec[Person] = GenCodec.materialize

final class CodeSizeTester extends AnyFunSuite:
