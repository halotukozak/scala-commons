...
import serialization.json.JsonStringOutput
...
case class Record(b: Boolean, i: Int, l: List[String], d: Double, @transientDefault s: String = "")
...
class CborInputOutputTest extends AnyFunSuite:
  private def roundtrip[T: GenCodec](value: T, binary: String, keyCodec: CborKeyCodec = CborKeyCodec.Default)(implicit
    pos: Position,
  ): Unit =
