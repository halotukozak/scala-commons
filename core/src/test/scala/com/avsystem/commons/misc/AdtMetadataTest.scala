...
abstract class HasGenCodecStructure[T](using macroInstances: MacroInstances[Unit, GenCodecStructure[T]]) {
  given genCodec: GenCodec[T] = macroInstances((), this).codec

  given genStructure: GenStructure[T] = macroInstances((), this).structure
}
