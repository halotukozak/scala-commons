...
object ComplexInstancesTest {
  ...
  abstract class HasComplexInstances[T](using
...
object MultipleImplicitImportsTest {
  ...
  abstract class HasGenCodecUsingAB[T](using instances: MacroInstances[(ACodec.type, BCodec.type), () => GenCodec[T]]) {
...
object AnnotationReferringToEnclosingObjectTest {
  ...
  abstract class HasMeta[T](using instances: MacroInstances[Unit, () => Meta[T]]) {
