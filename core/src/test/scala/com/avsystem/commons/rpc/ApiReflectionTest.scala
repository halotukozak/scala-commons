...
case class ApiInfo[T](@infer ts: TypeString[T], @multi @mangleOverloads @rpcMethodMetadata methods: List[MethodInfo[?]])
...
case class TypeParamInfo(@reifyName name: String) {
