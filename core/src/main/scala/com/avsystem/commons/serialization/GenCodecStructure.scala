...
import annotation.{bincompat, positioned}
import meta.*
...
final case class GenParamInfo[T](
...
@positioned(positioned.here) final case class GenUnionInfo[T](
...
@positioned(positioned.here) final case class GenCaseInfo[T](
  @reifyFlags flags: TypeFlags,
  @reifyName sourceName: String,
  @optional @reifyAnnot annotName: Opt[name],
