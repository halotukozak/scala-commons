...
//  private var peekedField: FieldInput = uninitialized
//
...
//        fi
//
//  def hasNext: Boolean = peekedField != null || original.hasNext
//
//  override def peekField(name: String): Opt[FieldInput] = original.peekField(name)
//}
