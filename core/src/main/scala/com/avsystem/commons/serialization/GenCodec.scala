...
object GenCodec {
  ...
  //    }
  //
  //    given fromTransparentWrapping[R, T](implicit tw: TransparentWrapping[R, T], wrapped: OOOFieldsObjectCodec[R]): OOOFieldsObjectCodec[T] =
  ...
  //  given bseqCodec[T: GenCodec]: GenCodec[BSeq[T]] = seqCodec[BSeq, T](GenCodec[T], implicitly[Factory[T, List[T]]])
  //  given iseqCodec[T: GenCodec]: GenCodec[ISeq[T]] = seqCodec[ISeq, T](GenCodec[T], implicitly[Factory[T, List[T]]])
  ...
  //
  //  given mapCodec[M[X, Y] <: BMap[X, Y], K: GenKeyCodec, V: GenCodec](
  ...
  //    )
  //
  //  given jMapCodec[M[X, Y] <: JMap[X, Y], K: GenKeyCodec, V: GenCodec](
  ...
  //  given fromTransparentWrapping[R, T](implicit
  //    tw: TransparentWrapping[R, T], wrappedCodec: GenCodec[R]
  //  ): GenCodec[T] =
  //    new Transformed(wrappedCodec, tw.unwrap, tw.wrap)
  //
  //  given fromFallback[T](implicit fallback: Fallback[GenCodec[T]]): GenCodec[T] =
  //    fallback.value
  //}
  //
  ...
  //    */
  //  given materializeImplicitly[T](implicit allow: AllowImplicitMacro[GenCodec[T]]): GenCodec[T] =
