...
final case class AnnotationOf[A, T](annot: A) extends AnyVal

object AnnotationOf {
  inline given materialize[A, T]: AnnotationOf[A, T] = ${ annotationOf[A, T] }
}
...
//
//  macro macros.misc.MiscMacros.optAnnotationOf[A, T]
//}
//
///**
...
//
//  macro macros.misc.MiscMacros.annotationsOf[A, T]
//}
//
///**
...
//
//  macro macros.misc.MiscMacros.hasAnnotation[A, T]
//}
//
///**
...
//
//  macro macros.misc.MiscMacros.selfAnnotation[A]
//}
//
///**
...
//
//  macro macros.misc.MiscMacros.selfOptAnnotation[A]
//}
//
/**
...
object SelfAnnotations {
  inline given materialize[A]: SelfAnnotations[A] = ${ selfAnnotations[A] }
}
