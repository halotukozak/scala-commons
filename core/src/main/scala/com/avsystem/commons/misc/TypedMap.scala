...
//  * Example:
//  * {{{
//  *   sealed abstract class AttributeKey[T](given valueCodec: GenCodec[T])
...
//  object Entry {
//    given pairToEntry[K[_], T](pair: (K[T], T)): Entry[K, T] = Entry(pair)
//  }
//
...
//  }
//
//  given typedMapCodec[K[_]](implicit
