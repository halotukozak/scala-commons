...
//  */
//abstract class AbstractValueEnum(protected given enumCtx: EnumCtx) extends ValueEnum
//
...
//
//  protected[this] given valName: ValName = macro macros.misc.MiscMacros.enumValName
//
//  protected[this] given enumCtx(givenName: ValName): EnumCtx =
