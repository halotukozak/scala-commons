...
//
//  given readerBasedFutureAsReal[T: Reader]: AsReal[Future[RawValue], Future[T]] = _.mapNow(read[T])
//  given writerBasedFutureAsRaw[T: Writer]: AsRaw[Future[RawValue], Future[T]] = _.mapNow(write[T])
//}
//
///**
