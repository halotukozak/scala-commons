...
//    given codec(implicit rawValueCodec: GenCodec[RawValue]): GenCodec[RawInvocation] = GenCodec.materialize
//  }
//
//  type RawRPC
...
//
//  given readerBasedAsReal[T: Reader]: AsReal[RawValue, T] = read[T](_)
//  given writerBasedAsRaw[T: Writer]: AsRaw[RawValue, T] = write[T](_)
//
...
//
//  given materializeFullInfo[T]: FullRPCInfo[T] = macro macros.rpc.RPCFrameworkMacros.fullInfoImpl[T]
//
//  /**
...
//    given asRealRPC: AsRealRPC[RealRPC] = macro macros.rpc.RPCFrameworkMacros.typeClassFromFullInfo
//    given asRawRPC: AsRawRPC[RealRPC] = macro macros.rpc.RPCFrameworkMacros.typeClassFromFullInfo
//    given metadata: RPCMetadata[RealRPC] = macro macros.rpc.RPCFrameworkMacros.typeClassFromFullInfo
//  }
//}
