...
//    given forList[T](implicit tct: TC[T]): TC[List[T]] = ForList(tct)
//  }
//  trait ImplicitMaterializers { this: TC.type =>
//    given materializeImplicitly[T](implicit allow: AllowImplicitMacro[TC[T]]): TC[T] = macro macros.TestMacros.materializeImplicitly[T]
//  }
//}
//
