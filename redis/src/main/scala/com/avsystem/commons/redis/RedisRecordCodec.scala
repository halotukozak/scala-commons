...
object RedisRecordCodec extends LowPriorityRedisRecordCodecs {
  ...
  implicit def forDataMap[M[X, Y] <: BMap[X, Y], F: RedisDataCodec, V: RedisDataCodec](implicit
  ...
  implicit def forDataSeq[M[X] <: BSeq[X], F: RedisDataCodec, V: RedisDataCodec](implicit
    fac: Factory[(F, V), M[(F, V)]],
  ...
  )(implicit fac: Factory[(F, V), To]): To = {
