...
abstract class AbstractMongoEntityCompanion[Implicits, IDType, E <: BaseMongoEntity.Aux[IDType]](implicits: Implicits)(
  ...
  given codec: GenObjectCodec[E] = instances(implicits, this).codec
  given format: MongoAdtFormat[E] = instances(implicits, this).format
  given meta: MongoEntityMeta[IDType, E] = instances(implicits, this).meta
...
/** Base class for companion objects of types representing MongoDB entities. Entities may be case classes or sealed
  ...
  */
abstract class MongoEntityCompanion[IDType, E <: BaseMongoEntity.Aux[IDType]](implicit
  instances: MacroInstances[BsonGenCodecs.type, MongoEntityInstances[IDType, E]]
