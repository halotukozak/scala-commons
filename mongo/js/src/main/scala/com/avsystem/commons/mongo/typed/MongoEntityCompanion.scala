 ...
 * instance.
 */
abstract class MongoDataCompanion[T](implicit instances: MacroInstances[Unit, () => GenObjectCodec[T]])
 ...
 * instance.
 */
abstract class MongoEntityCompanion[T <: BaseMongoEntity](implicit
  instances: MacroInstances[Unit, () => GenObjectCodec[T]],
