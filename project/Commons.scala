...
//        params = Map("mongodb-version" -> "8.0", "mongodb-replica-set" -> "test-rs")
//      )
//    ),
...
//        inAnyProject -- inProjects(analyzer, macros, `core-js`, comprof)
//    )
//
...
//
//  lazy val macros =
//    mkSubProject.settings(jvmCommonSettings, libraryDependencies += "org.scala-lang" % "scala-reflect" % scala2Version)
//
...
//    .dependsOn(`core-js`)
//    .settings(jsCommonSettings, sameNameAs(mongo), sourceDirsSettings(_.getParentFile))
//
