...
//    *     }
//    *
//    *     given forList[T](implicit forElement: Traverser[T]): Traverser[List[T]] =
...
//      q"""
//        given $deferredName: $DeferredInstanceCls[$tcTpe] with $tcTpe = $PredefObj.???
//        $unguarded
//       """
//
//    def guarded: Tree =
//      q"""
//        given $deferredName: $DeferredInstanceCls[$tcTpe] with $tcTpe =
